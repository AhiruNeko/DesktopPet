...
namespace Frontend
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void StartGlobalMouseHook()
        {
            ...
            _globalHook.MouseDoubleClick += PetMouseDoubleClick;
        }
        ...
        private async void PetMouseDoubleClick(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                this.UpdateGeneralStatus();
                this.status.MouseLeftDoubleClick = true;
                await SendDataAsync();
                this.status.MouseLeftDoubleClick = false;
            }
            if (e.Button == MouseButtons.Right)
            {
                this.UpdateGeneralStatus();
                this.status.MouseRightDoubleClick = true;
                await SendDataAsync();
                this.status.MouseRightDoubleClick = false;
            }
        }
